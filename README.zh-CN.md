...
| 功能 | 说明 |
|------|------|
| 问题识别与分类 | 自动识别法域、交易类型、付款性质；区分纯粹外汇管理 / 纯粹银行合规与AML / 纯粹税务 / 跨领域 |
...
| 跨境付款、汇款、银行 KYC、资金来源、OFAC、制裁、反洗钱、支付牌照 | 资金合规 — 银行合规/AML/制裁 |
